...
public class TestSearch {
	...
	public void testCopyFiles() {
		try {
			File file = new File("/root/git/qutang/src/main/java/com/qt/ext/action/");
	...
	public void searchByTerm() {
		su.searchByTerm("content","good",3);
	}
...
//		su.searchByTermRange("name","a","s",10);
		...
		su.searchByTermRange("range","0","3", 5);
	}
	
	@Test
	public void searchByNumRange() {
		su.searchByNumricRange("source",0,3, 5);
	}
	...
	public void searchByWildcard() {
		//匹配@itat.org结尾的所有字符
		su.searchByWildcard("content", "*ood", 10);
		//匹配j开头的有三个字符的name
		su.searchByWildcard("title", "j????", 10);
	}
	
	@Test
	public void searchByBoolean() {
		su.searchByBoolean(10,1);
	}
...
//		query = parser.parse("email:*@itat.org");
	...
	public void testSearchPage01() {
		su.searchPage("new", 1,20);
		System.out.println("-------------------------------");
//		su.searchNoPage("java");
		su.searchPageByAfter("new", 2,20);
	}
