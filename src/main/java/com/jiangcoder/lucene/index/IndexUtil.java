...
public class IndexUtil {
	...
	public IndexUtil() {
		try {
			...
			directory = FSDirectory.open(new File("/workspace/in/lucene/index02"));
	...
	public void search01() {
		try {
			...
			TermQuery query = new TermQuery(new Term("email", "cc@cc.org"));
	...
	public void search02() {
		try {
			...
			TermQuery query = new TermQuery(new Term("content", "shit"));
			TopDocs tds = searcher.search(query, 10);
			for (ScoreDoc sd : tds.scoreDocs) {
				Document doc = searcher.doc(sd.doc);
